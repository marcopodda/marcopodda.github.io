...
#
# Takes a set of bibtex of publications and converts
# them for use with [academicpages.github.io](academicpages.github.io).
    ...
    for bib_id in bibdata.entries:
        ...
        try:
            ...
            if url:
                ...
                md += html.escape(clean_title.replace("-", "+"))
                md += '){:target="_blank"} for full citation'
